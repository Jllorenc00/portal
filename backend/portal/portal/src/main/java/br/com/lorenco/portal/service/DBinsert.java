package br.com.lorenco.portal.service;
...
import br.com.lorenco.portal.repository.PessoaRepository;
...
public class DBinsert implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (int i = 1; i <= 20; i++) {
            ...
            noticia.setCorpo("Este é o corpo da notícia número " + i + ", com detalhes variados sobre o tema "
                    + (random.nextInt(50) + 1) + ".");
